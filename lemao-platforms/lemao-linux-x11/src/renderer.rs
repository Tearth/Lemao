...
impl LinuxX11Renderer {
    pub fn new(display: *mut x11::_XDisplay, frame_buffer_config: *mut glx::__GLXFBConfigRec, window: u64) -> Self {
        unsafe {
            ...
            let context =
                (gl.glXCreateContextAttribsARB)(mem::transmute(display), frame_buffer_config, ptr::null_mut(), 1, context_attributes.as_ptr() as *const i32);

            x11::XSync(mem::transmute(display), 0);
