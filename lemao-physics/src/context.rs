...
use crate::{collisions, contacts, solvers};
use core::f32;
...
impl PhysicsContext {
    ...
    pub fn update(&mut self, mut delta_time: f32) -> Result<(), String> {
        ...
        delta_time /= self.substeps as f32;
            ...
            for body1_id in 0..self.bodies.len() {
                for body2_id in 0..self.bodies.len() {
                    ...
                    if let Some(collision) = collision {
                        ...
                        let contact = if body1.shape == BodyShape::Box && body2.shape == BodyShape::Box {
                        ...
                        let pressure = solvers::velocity::solve(body1, body2, &collision, &contact);
                        solvers::friction::solve(body1, body2, &collision, &contact, pressure);
