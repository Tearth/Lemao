pub fn read_u8(data: &Vec<u8>, index: usize) -> u8 {
    data[index]
}

pub fn read_le_u16(data: &Vec<u8>, index: usize) -> u16 {
    (read_u8(data, index) as u16) | ((read_u8(data, index + 1) as u16) << 8)
}

pub fn read_le_u32(data: &Vec<u8>, index: usize) -> u32 {
    (read_le_u16(data, index) as u32) | ((read_le_u16(data, index + 2) as u32) << 16)
}

pub fn read_le_u64(data: &Vec<u8>, index: usize) -> u64 {
